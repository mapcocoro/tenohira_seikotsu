...
export default function InstagramSection() {
  ...
  return (
    <section id="instagram" ref={sectionRef} className="py-20 relative bg-chalkboard-dark/50">
      <div className="container mx-auto px-4">
        {/* セクションタイトル */}
        <div className="text-center mb-16">
          <span className="inline-block bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white px-4 py-1 rounded-full text-sm font-bold mb-4 animate-bounce-slow">
            INSTAGRAM
          </span>
        ...
        >
          <div className="chalk-box p-6 text-chalk-white max-w-4xl mx-auto">
            {/* LightWidget埋め込みプレースホルダー */}
            <div className="relative min-h-[400px] bg-chalkboard-dark rounded-lg overflow-hidden">
              {/*
              ...
              */}
              ...
              {/* プレースホルダー表示 */}
              <div className="absolute inset-0 flex flex-col items-center justify-center text-chalk-white/60">
                <div className="text-center">
                  <span className="text-6xl mb-4 block">📸</span>
                  <p className="text-xl mb-2">Instagram Feed</p>
                  <p className="text-sm">LightWidgetでInstagramを埋め込み</p>
                  <p className="text-xs mt-4 text-chalk-white/40">
                    ※LightWidgetのウィジェットIDを設定してください
                  </p>
                </div>
              </div>

              {/* ダミーのInstagramグリッド（実際の埋め込み前の表示用） */}
            ...
            <div className="text-center mt-6">
              <a
                ...
                className="pop-button inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white px-8 py-4 rounded-full text-xl font-bold hover:opacity-90 transition-opacity"
              >
